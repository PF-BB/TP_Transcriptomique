...
> **Question** : Chargez en mémoire les fichiers "data_1.txt", "data_2.txt", "data_3.txt", "data_4.txt" et "pheno.txt" ? Expliquez chacune des options utilisée.
...
> **Question** : Affichez l'aide de la fonction. Procédez à la normalisation. Justifiez les paramètres choisis. Produisez les boxplots des données après normalisation des quantiles. Que constatez-vous ?

Les données sont à présent normalisées et prêtes à l'emploi. 

> **Question** : Calculez à nouveau des composantes principales et représentez graphiquement les observations en fonctions des deux premières composantes principales. La couleur des points s'affichera en fonction de la colonne ID du tableau de données pheno et la forme des points (paramètre pch de la fonction plot) s'affichera en fonction de la collonne "prodiff". Que constatez-vous ?
